"""sim data analysis the arrays were saved as np.c_[kx, freq, vg] This is the script that I used to first look at the
simulation data results that were generated by script-2.py. A more thorough look is in script-4.py """
