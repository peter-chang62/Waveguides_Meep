...
This script analyzes results from sim_output/07-19-2022 and
sim_output/09-08-2022 that were generated by script-2 and script-5,
respectively

A script using PyNLO to apply the waveguide dispersion is in script-7.py, with
a second version in script-8.py that was separated from script-7.py for
decluttering
"""
