...
Al2O3_susc_o = [
    mp.LorentzianSusceptibility(frequency=Al2O3_frq1, gamma=Al2O3_gam1, sigma_diag=Al2O3_sig1 * mp.Vector3(1, 1, 0)),
...
Al2O3_susc_e = [
    mp.LorentzianSusceptibility(frequency=Al2O3_frq1, gamma=Al2O3_gam1, sigma_diag=Al2O3_sig1 * mp.Vector3(0, 0, 1)),
...
Al2O3 = mp.Medium(epsilon=1.0, E_susceptibilities=Al2O3_susc_o + Al2O3_susc_e, valid_freq_range=Al2O3_range)
